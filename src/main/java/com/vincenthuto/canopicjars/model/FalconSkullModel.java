...
public class FalconSkullModel extends SkullModelBase {
	private final ModelPart root;
	protected final ModelPart head;

	public FalconSkullModel(ModelPart p_170945_) {
		this.root = p_170945_;
	...
	public static MeshDefinition createHeadModel() {
		...
		partdefinition.addOrReplaceChild("head",
				CubeListBuilder.create().texOffs(0, 0)
						.addBox(-3.0F, -1.3711F, -1.5F, 6.0F, 6.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(0, 12)
						.addBox(-1.0F, 0.6289F, -2.5F, 2.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(8, 12)
						.addBox(-1.0F, 1.8289F, -4.5F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)),
